In this project, I've built the **Nxt Watch** by applying the concepts I have learned till now.
...
- **Login Route**
  ...
  - When an _unauthenticated_ user tries to open the Home, Trending, Gaming, Saved Videos, and Video Details Route, then the page is navigated to the Login Route
  - When an _authenticated_ user tries to open the Home, Trending, Gaming, Saved Videos, and Video Details Route, then the page is navigated to the respective route
  - When an _authenticated_ user tries to open the Login Route, then the page is navigated to the Home Route
  - When the **Show Password** checkbox is checked, then the password is shown
  - When the **Show Password** checkbox is unchecked, then the password is masked

- **Home Route**

  - When an _authenticated_ user opens the Home Route,
    - An HTTP GET request is made to the **Home Videos API URL** with `jwt_token` in the Cookies and query parameter `search` with the initial value as an empty string
      - **_Loader_** is displayed while fetching the data
      - After the data is fetched successfully, the list of videos is displayed
      - If the HTTP GET request made is unsuccessful, then the [Failure View](https://assets.ccbp.in/frontend/content/react-js/nxt-watch-home-failure-light-theme-lg-output-v0.png) is displayed
        - When the **Retry** button is clicked, an HTTP GET request is made to the **Home Videos API URL**
    - When a non-empty value is provided in the search input and the search icon button is clicked
      ...
      - **_Loader_** is displayed while fetching the data
      - After the data is fetched successfully, the list of videos is displayed
    - When the HTTP GET request made to the **Home Videos API URL** returns an empty list, then the [No Videos View](https://assets.ccbp.in/frontend/content/react-js/nxt-watch-home-no-videos-light-theme-lg-output-v0.png) is displayed
  - When a **Video** is clicked, then the page is navigated to the Video Item Details Route
  ...
  - When the **Saved Videos** link in the Sidebar is clicked, then the page is navigated to the Saved Videos Route

- **Trending Route**

  - When an _authenticated_ user opens the Trending Route,
    - An HTTP GET request is made to the **Trending Videos API URL** with `jwt_token` in the Cookies
      - **_Loader_** is displayed while fetching the data
      - After the data is fetched successfully, the list of videos is displayed
      - If the HTTP GET request made is unsuccessful, then the [Failure View](https://assets.ccbp.in/frontend/content/react-js/nxt-watch-trending-failure-light-theme-lg-output-v0.png) is displayed
        - When the **Retry** button is clicked, an HTTP GET request is made to the **Trending Videos API URL**
  - When a **Video** is clicked, then the page is navigated to the Video Item Details Route
...
- **Gaming Route**
  ...
  - When an _authenticated_ user opens the Gaming Route,
    - An HTTP GET request is made to the **Gaming Videos API URL** with `jwt_token` in the Cookies
      - **_Loader_** is displayed while fetching the data
      - After the data is fetched successfully, the list of videos is displayed
      - If the HTTP GET request made is unsuccessful, then the [Failure View](https://assets.ccbp.in/frontend/content/react-js/nxt-watch-gaming-failure-light-theme-lg-output-v0.png) is displayed
        - When the **Retry** button is clicked, an HTTP GET request is made to the **Gaming Videos API URL**
  - When a **Video** is clicked, then the page is navigated to the Video Item Details Route
  - When the **Home** link in the Sidebar is clicked, then the page is navigated to the Home Route
  - When the **Trending** link in the Sidebar is clicked, then the page is navigated to the Trending Route
  - When the **Saved Videos** link in the Sidebar is clicked, then the page is navigated to the Saved Videos Route
...
- **Video Item Details Route**
  ...
  - When an _authenticated_ user opens the Video Item Details Route
    - An HTTP GET request is made to the **Video Details API URL** with `jwt_token` in the Cookies and `video_id` as a path parameter
      - **_Loader_** is displayed while fetching the data
      - After the data is fetched successfully, the response received is displayed
      - If the HTTP GET request made is unsuccessful, then the [Failure View](https://assets.ccbp.in/frontend/content/react-js/nxt-watch-video-item-details-failure-light-theme-lg-output-v0.png) is displayed
        - When the **Retry** button is clicked, an HTTP GET request is made to the **Video Details API URL**
  - Corresponding video is displayed using `react-player` package
  - Initially, all the three buttons (Like, Dislike, Save) is inactive
  ...
  - When the **Save** button is clicked,
    - It should change to active state and the respective video details is added to the list of saved videos
    - **Save** button text is changed to **Saved**
  - When the **Saved** button is clicked
    ...
    - **Saved** button text is changed to **Save**

- **Saved Videos Route**

  - When an _authenticated_ user opens the Saved Videos Route,
    - If the list of saved videos is empty, then the [No Saved Videos Found View](https://assets.ccbp.in/frontend/content/react-js/nxt-watch-no-saved-videos-light-theme-lg-output-v0.png) is displayed
    - The list of saved videos is displayed
  - When a **Video** is clicked, then the page is navigated to the Video Item Details Route
  - When the **Home** link in the Sidebar is clicked, then the page is navigated to the Home Route
  - When the **Trending** link in the Sidebar is clicked, then the page is navigated to the Trending Route
  - When the **Gaming** link in the Sidebar is clicked, then the page is navigated to the Gaming Route
...
- **Header**
  ...
  - When the Website logo is clicked, then the page is navigated to the Home Route
  - When the theme icon button is clicked, then the theme is changed accordingly
  - When the **Logout** button is clicked, then the [Logout Popup](https://assets.ccbp.in/frontend/content/react-js/nxt-watch-logout-popup-light-theme-lg-output-v0.png) is displayed
    - When the **Cancel** button is clicked, then the popup is closed and the page should not be navigated
    - When the **Confirm** button is clicked, then the page is navigated to the Login Route
...
- To build this project, I've used <a href='https://learning.ccbp.in/frontend-development/course?c_id=2f4192f7-7495-49ca-a6ce-6b74005e25f1&s_id=b01fca1c-aa5c-4d79-b81e-0220e7649bd0&t_id=416f0cab-8425-413b-9157-c7b4d4ae4467' target="_blank">React Popup</a> and <a href='https://learning.ccbp.in/frontend-development/course?c_id=2f4192f7-7495-49ca-a6ce-6b74005e25f1&s_id=b6392b63-25f6-4215-be09-9f23ad91d789&t_id=416f0cab-8425-413b-9157-c7b4d4ae4467' target="_blank">React Video Player</a>
...
- [https://assets.ccbp.in/frontend/react-js/nxt-watch-profile-img.png](https://assets.ccbp.in/frontend/react-js/nxt-watch-profile-img.png) alt is **profile**
...
- [https://assets.ccbp.in/frontend/react-js/nxt-watch-no-search-results-img.png](https://assets.ccbp.in/frontend/react-js/nxt-watch-no-search-results-img.png) alt is **no videos**
- [https://assets.ccbp.in/frontend/react-js/nxt-watch-no-saved-videos-img.png](https://assets.ccbp.in/frontend/react-js/nxt-watch-no-saved-videos-img.png) alt is **no saved videos**
...
- [https://assets.ccbp.in/frontend/react-js/nxt-watch-facebook-logo-img.png](https://assets.ccbp.in/frontend/react-js/nxt-watch-facebook-logo-img.png) alt is **facebook logo**
- [https://assets.ccbp.in/frontend/react-js/nxt-watch-twitter-logo-img.png](https://assets.ccbp.in/frontend/react-js/nxt-watch-twitter-logo-img.png) alt is **twitter logo**
- [https://assets.ccbp.in/frontend/react-js/nxt-watch-linked-in-logo-img.png](https://assets.ccbp.in/frontend/react-js/nxt-watch-linked-in-logo-img.png) alt is **linkedin logo**
...
- **NxtWatch** is a responsive React-based video streaming app with routing, theming, and protected routes.  
- It replicates a real-world platform like YouTube with features like search, saved videos, and video details.

- The app supports **light/dark themes**, responsive layouts, and smooth user navigation across routes.  
- JWT-based authentication ensures secure access to protected routes like Home, Trending, and Saved Videos.

- API integration and state management are handled cleanly, with loaders, failure views, and retry options.  
- Modular components and conditional rendering enhance both reusability and user experience.

- This project demonstrates my skills in building scalable, interactive, and user-friendly front-end systems.  
- It brings together concepts like authentication, REST APIs, and dynamic routing in a polished UI.

- 🔗 **Live Demo:** [https://nxtwatchup.ccbp.tech](https://nxtwatchup.ccbp.tech) 

Thanks for checking it out! Feel free to ⭐ the repo, fork it, or share feedback.  
**Happy Coding!** 🎬💡
